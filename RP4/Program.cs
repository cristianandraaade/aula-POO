...
class Program
{
    public static void Main()
    {
        ...
        PontoVO p1 = new PontoVO(1,21,"p1");
        ...
        Console.WriteLine("Ponto Removido " + c1.excluir("p1").getDescription());
    }
}